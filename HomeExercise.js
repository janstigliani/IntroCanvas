...
//         rect.height = (600/size)-(Math.random()*(Math.floor(500/size))+4);
//         rect.originX = incrementX;
//         rect.originY = incrementY + (600 / size - rect.height) / 2;
...
//         rect.row = row;
//         rect.speedX = Math.random()*2+2;

//         // Adjust speed for odd rows
//         if (rect.row % 2 === 1) {
